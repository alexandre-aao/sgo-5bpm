...
// Trilho "Pendências do Turno" do Meu Turno (conflitos do cartão + eventos sem
// Nº OS/SEI — mesma origem do card "Pendências" do Dashboard, ver
// AlertasEPatrulhamento.tsx) — espelha #turno-avisos em renderTurnoTab()
// (public/app.js).
      ...
      <div className="dash-alertas-lista">
        {avisos.length === 0 ? (
          <div className="dash-alertas-vazio">
            <CheckCircle />
            <span>Nenhuma pendência para este turno.</span>
          </div>
        ) : (
          avisos.map((a, i) => {
